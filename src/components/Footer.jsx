...
const sendBtn = <svg xmlns="http://www.w3.org/2000/svg" height="25" viewBox="0 -960 960 960" width="25"><path d="m375-240-43-43 198-198-198-198 43-43 241 241-241 241Z"/></svg>
  ...
  return (
    <>
     <div className="PreFooter">
        ...
        <div>
            {mapIcon}
            <p><b>Vast services network</b> <br /> 1000 Mi service-centers across 600 cities</p>
        </div>
    </div>
    ...
    <div className="footerBorder">
        <div>Copyright © 2010 - 2021 Xiaomi. All Rights Reversed</div>
    </div>
    </>
  )
}
